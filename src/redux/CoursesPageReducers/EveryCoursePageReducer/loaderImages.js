...
export const initializeState = async (courseId) => {
    ...
    курса и эффективно продолжать свои занятия.`}
            ...
            },
            {
                ...
                overviewSectionData: {
                    salaryData: {
                        salaryTitle: "тестировщик",
                        salary: [
                            { position: "Junior", description: "Основы тестирования программного обеспечения, выполнение ручных тестов, написание базовых отчетов о дефектах.", salary: "60 000 ₽", backgroundColor: "#c5ddff" },
                            { position: "Middle", description: "Разработка и выполнение автоматизированных тестов, работа с базами данных, анализ требований и оценка тестовых сценариев.", salary: "100 000 ₽", backgroundColor: "#b8efcf" },
                            { position: "Senior", description: "Руководство командой тестировщиков, разработка стратегий тестирования, работа с различными методами тестирования.", salary: "150 000 ₽", backgroundColor: "#ffce94" }
                        ]
                    },
                    ...
                    yourFutureData: {
                        careerChoice: [
                            { employment: "Трудоустройство", description: "Знания, полученные на курсе, позволят вам претендовать на позиции тестировщика ПО и начать карьеру в IT. Мы поможем вам подготовить профессиональное резюме, собрать портфолио и пройти успешное собеседование. Вы научитесь выполнять тестовые задания и работать с командами разработчиков, повышая качество программного обеспечения.", income: "80 000—150 000 ₽", backgroundColor: "#C5DDFF" },
                            { employment: "Создание бизнеса", description: "Вы можете начать свой собственный бизнес в сфере тестирования ПО. Совместно с партнёрами, вы сможете предлагать услуги по автоматизации тестирования, разработке тестовых сценариев и обеспечению качества программных продуктов. Кроме того, вы получите знания, необходимые для ведения собственного бизнеса.", income: "100 000—300 000 ₽", backgroundColor: "#B8EFCF" }
                        ],
                        resume: {
                            position: "QA Engineer",
                            salary: "60000 ₽",
                            skills: {
                                firstCol: ["Тестирование веб-приложений и мобильных приложений.", "Создание тест-кейсов и тестовых сценариев.", "Поиск, анализ и документирование багов."],
                                secondCol: ["Работа с инструментами автоматизации тестирования (Selenium, Postman).", "Использование систем отслеживания багов (Jira, Bugzilla).", "Проведение регрессионного, функционального и интеграционного тестирования."]
                            }
                        }
                    },
                    accordionData: [
