    ...
    курса и эффективно продолжать свои занятия.`}
            ...
            },
            {
                ...
                overviewSectionData: {
                    ...
                    "contentParagraf": `В процессе обучения вы изучите различные методы тестирования программного обеспечения, такие как функциональное, регрессионное и нагрузочное тестирование. Программа курса включает в себя практические занятия с использованием инструментов автоматизации тестирования, знакомство с API и тестированием мобильных приложений. В конце курса вы будете готовы к профессиональной работе в качестве тестировщика ПО.`,
                    carouselImages,
                    priceImages,
                    couchesData,
                    couchesBackgroundImages,
