...
const initialState = {
    events: {
        firstRow: [
            {
                id: "queensMove", event: "Турнир", imgSrc: image1, name: "Ход королевы", text: `Приглашаем на Шахматный Фестиваль "Ход Королевы"! Вас ждут турниры, мастер-классы от
            ...
            {
                id: "beginnersHackathon", event: "Встреча", imgSrc: image2, name: "Хакатон для начинающих программистов", text: `Погрузитесь в мир программирования на нашем Хакатоне! Увлекательные задания, командная
            ...
            {
                id: "gameDev", event: "Интенсив", imgSrc: image3, name: "GameDev", text: `Узнайте, как создать свою первую игру за один уикенд! Практические занятия, советы от
        ...
        secondRow: [
            {
                id: "modernTechnology", event: "Вебинар", imgSrc: image4, name: "Современные технологии веб-разработки", text: `Приглашаем вас на вебинар, посвященный современным технологиям веб-разработки. Узнайте о
            ...
            {
                id: "cyberMeeting", event: "Кибервстреча", imgSrc: image5, text: `Погрузитесь в мир программирования на нашем Хакатоне! Увлекательные задания, командная
        ...
        thirdRow: [
            {
                id: "itInnovation", event: "Мероприятие", imgSrc: image6, name: "День IT-инноваций", text: `Присоединяйтесь к нам на День IT-инноваций! Откройте для себя новейшие технологии,
            узнайте о трендах в IT-индустрии и пообщайтесь с лидерами рынка.`, date: "20 июля 2024", backgroundColor: "#C5DDFF"
            },
            {
                id: "creativeCoding", event: "Мастер-класс", imgSrc: image7, name: "Креативный кодинг", text: `Приглашаем на Креативный кодинг! Исследуйте искусство программирования, участвуйте в
            творческих воркшопах и развивайте свои навыки в уникальной атмосфере.`, date: "30 июля 2024", backgroundColor: "#FFEEF6"
            },
            {
                id: "designIntensive", event: "Интенсив", imgSrc: image8, name: "Дизайн-интенсив", text: `Присоединяйтесь к нашему Дизайн-интенсиву! Погрузитесь в мир графического дизайна,
